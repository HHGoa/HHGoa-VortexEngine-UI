...
const DropdownBtn: React.FC = () => {
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      {isDropdownOpen && (
        <div className="absolute left-0 mt-2 w-full border-2 gradient-border rounded-md shadow-lg bg-transparent">
          <div className="py-1">
            <a
              href="#"
              className="block px-4 py-4 text-sm text-gray-700 hover:bg-gradient-to-r from-purple-500 via-blue-500 to-green-500 rounded-md"
            >
              <CustomButton />
            </a>
            <a
